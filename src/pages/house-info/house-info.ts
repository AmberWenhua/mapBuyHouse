...
export class HouseInfoPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public http: HttpProvider, 
    ...
    this.houseInfo = [
      {'name':'houseinfo_area', 'value': '', 'label': '城市'},
      {'name':'houseinfo_area_detail', 'value': '', 'label': '区县'},
      {'name':'houseinfo_name', 'value': '', 'label': '名称'},
      {'name':'houseinfo_type', 'value': '', 'label': '类型'},
      ...
      {'name':'houseinfo_all_company', 'value': '', 'label': '开发商'},
      {'name':'houseinfo_subway', 'value': '', 'label': '地铁'},
      {'name':'houseinfo_add', 'value': '', 'label': ' 地址'},
      {'name':'houseinfo_tel', 'value': '', 'label': ' 咨询电话'},
    ];
